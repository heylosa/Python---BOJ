...
from PyQt5.QtWidgets import QLabel, QLineEdit, QTextEdit  ## TEXT EDIT LINE
...
# image load, PYQT에 어떻게 되는지 CHECK
plt.figure(figsize=(X_max / 2, Y_max / 2))  # figure size 조절
...
plt.ylabel('Y')
plt.show()
df1.tail(3)  # Euler angle로부터 c축 각도 계산, table 출력
